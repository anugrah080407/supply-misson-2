...
bottomBody = Bodies.rectangle(width/2,height-70,200,20,{isStatic:true});
World.add(world,bottomBody);
leftBody = Bodies.rectangle(width/2-100,height-100,20,100,{isStatic:true});
World.add(world,leftBody);
rightBody = Bodies.rectangle(width/2+100,height-100,20,100,{isStatic:true});
